...
const Scalar RED(50,0,255), GREEN1(30,220,10), GREEN2(80,150,10), BLUE1(220,100,20), BLUE2(200,130,20), CYAN(255,255,0), ORANGE(65,64,255);
...
//	dims = _dims;};
	...
	void createEllipse(double _center_x, double _center_y, double a, double b, unsigned int n_points);
	...
	void transfromToBoard(const geometry_msgs::Pose & _tool_curr_in_slvrf, const geometry_msgs::Pose & _tool_dest_in_slvrf);
	...
	void setTransientNotification(string _msg, double _origin_x, double _origin_y, unsigned int _duration_counts);
